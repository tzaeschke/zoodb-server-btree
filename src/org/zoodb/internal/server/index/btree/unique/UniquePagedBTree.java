...
public class UniquePagedBTree extends PagedBTree<UniquePagedBTreeNode> {
	...
	public UniquePagedBTree(UniquePagedBTreeNode root, int innerNodeOrder,
			int leafOrder, BTreeBufferManager bufferManager) {
		super(root, innerNodeOrder, leafOrder, bufferManager);
	}

	public UniquePagedBTree(int innerNodeOrder, int leafOrder,
